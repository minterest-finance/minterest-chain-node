...
//! DATE: 2021-06-27, STEPS: [50, ], REPEAT: 20, LOW RANGE: [], HIGH RANGE: []
...
/// Weight functions needed for whitelist_module.
...
impl<T: frame_system::Config> WeightInfo for MinterestWeight<T> {
	fn add_member(m: u32, ) -> Weight {
		(34_860_000 as Weight)
			// Standard Error: 17_000
			.saturating_add((607_000 as Weight).saturating_mul(m as Weight))
