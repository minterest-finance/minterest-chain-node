use frame_support::sp_runtime::app_crypto::sp_core::offchain::{
	DbExternalities, Externalities, HttpError, HttpRequestId, HttpRequestStatus, OpaqueNetworkState, StorageKind,
	Timestamp,
};
...
// It can be done like more general by taking a struct suitable hooks (like commented one).
#[derive(Clone)]
...
impl<T> DbExternalities for OffChainExtWithHooks<T>
where
	T: DbExternalities,
{
